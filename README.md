...
This connector models Colorado APACD data into the Tuva claims input layer for downstream processing and analytics.

## Pre-requisites
1. You have data from Colordo APACD
...
The table names are the same as in the Colorado APACD data dictionayr.  If you decided to rename these tables:
